    ...
    <>
      ...
      <div className={styles.modalContainer}>
        <div className={styles.modalHeaderContainer}>
          {votedToday ? (
            <h3 className={styles.modalHeader}>Oops!</h3>
          ) : (
            <h3 className={styles.modalHeader}>{selectedCompetitor}</h3>
          )}
        ...
        <div className={styles.modalBody}>
          {votedToday ? (
            <>
              <p>
                Looks like you already voted for{" "}
                <span className={styles.lastVotedFor}>{lastVotedFor}</span>{" "}
                today.
              </p>
